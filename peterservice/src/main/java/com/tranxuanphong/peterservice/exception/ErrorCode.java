...
public enum ErrorCode { 
  ...
  FLASHSALE_PRODUCT_NOT_EXISTS(1013,"FLASH SALE NOT FOUND product", HttpStatus.NOT_FOUND),
  FLASHSALE_PRODUCT_EXISTS(1013,"FLASH SALE product exists", HttpStatus.BAD_REQUEST),
